...
I built **Duckling**, a GUI for docling that saves you from having to remember 40+ command-line flags. If you just want to see the [shiny new UI](#the-front-end), feel free to skip ahead. Otherwise, stick around for the story of how I used AI coding assistants to build this thing, and what I learned along the way.

Quick links if you want to dive in: [GitHub Repository](https://github.com/davidgs/duckling) | [Live Documentation](https://duckling-ui.org) | [Security Warning](#limitations)
