...
Ik heb **Duckling** gebouwd, een grafische gebruikersinterface (GUI) voor docling waarmee je niet meer dan 40 commandoregelvlaggen hoeft te onthouden. Als je alleen de [glimmende nieuwe UI](#the-front-end) wilt zien, kun je gerust verder scrollen. Blijf anders lezen voor het verhaal over hoe ik AI-codeerassistenten heb gebruikt om dit te bouwen, en wat ik onderweg heb geleerd.

Snelle links om direct aan de slag te gaan: [GitHub-repository](https://github.com/davidgs/duckling) | [Live documentatie](https://duckling-ui.org) | [Beveiligingswaarschuwing](#limitations)
