...
Ich habe **Duckling** entwickelt, eine grafische Benutzeroberfläche zum Dokumentieren, die Ihnen das Merken von über 40 Kommandozeilenparametern erspart. Wenn Sie nur die [neue, ansprechende Benutzeroberfläche](#the-front-end) sehen möchten, können Sie diesen Abschnitt überspringen. Ansonsten bleiben Sie dran und erfahren Sie, wie ich KI-Programmierassistenten beim Entwickeln dieses Projekts eingesetzt habe und was ich dabei gelernt habe.

Hier sind die Links für alle, die direkt loslegen möchten: [GitHub-Repository](https://github.com/davidgs/duckling) | [Live-Dokumentation](https://duckling-ui.org) | [Sicherheitshinweis](#limitations)
